...
export function QuickMedsShocksPanel({
  ...
  return (
    <div className="bg-slate-900 rounded-xl border border-slate-800 p-2 sm:p-2.5 flex flex-col gap-1.5 sm:gap-2 shadow-xl w-full max-w-full h-auto min-h-[185px] md:h-[185px] md:min-h-0 overflow-y-auto">
      {/* Section Title */}
