...
export function QuickMedsShocksPanel({
  ...
  return (
    <div className="bg-slate-900 rounded-xl border border-slate-800 p-2.5 sm:p-3 flex flex-col gap-2.5 shadow-xl shrink-0 sm:-mt-2">
      {/* Section Title */}
      <div className="flex items-center justify-between border-b border-slate-800 pb-1.5">
        ...
        <span className="text-[10px] text-slate-400 font-bold">AHA Protocol 2025</span>
      </div>
      ...
      <div className="grid grid-cols-5 gap-1.5">
        ...
        <button
          ...
          className={`py-2 px-1 rounded-lg text-center font-black transition-all cursor-pointer flex flex-col items-center justify-center border ${
        ...
        >
          <span className="text-[10px] uppercase font-mono block leading-none">SHOCKABLE</span>
          <span className="text-[8.5px] opacity-80 mt-0.5">VF / pVT</span>
        </button>
        ...
        >
          <span className="text-[9px] sm:text-[10px] uppercase font-mono block leading-none tracking-tighter">NON-SHOCKABLE</span>
          <span className="text-[8.5px] opacity-80 mt-0.5">Asystole/PEA</span>
        </button>
        ...
        >
          <span className="text-[9px] sm:text-[10px] uppercase font-mono block leading-none tracking-tighter">BRADYCARDIA</span>
          <span className="text-[8.5px] opacity-80 mt-0.5">HR &lt; 50</span>
        </button>
        ...
        >
          <span className="text-[9px] sm:text-[10px] uppercase font-mono block leading-none tracking-tighter">TACHYCARDIA</span>
          <span className="text-[8.5px] opacity-80 mt-0.5">HR &ge; 150</span>
        </button>
        ...
        >
          <span className="text-[10px] uppercase font-mono block leading-none">ROSC</span>
          <span className="text-[8.5px] opacity-80 mt-0.5">Pulse Back</span>
        </button>
      </div>
      ...
      {lastRhythmDecision === 'shockable' && (
        <button
          ...
          className={`w-full py-2.5 px-3 rounded-xl font-black text-xs flex items-center justify-between cursor-pointer transition-all border shadow-lg active:scale-95 ${
            shockButtonFlashing
      ...
      <div className="grid grid-cols-3 gap-2">
        ...
        <button
          ...
          className={`p-2 rounded-lg text-left transition-all active:scale-95 cursor-pointer flex flex-col justify-between border ${
            epiAlertActive
        ...
        >
          <div className="flex items-center justify-between">
            <span className="text-[11px] sm:text-[12px] font-black text-cyan-300 font-mono leading-tight">EPINEPHRINE</span>
            <span className="text-[10px] font-mono font-bold bg-cyan-950 text-cyan-300 px-1 rounded border border-cyan-800 ml-1 shrink-0">
              #{epiCount}
            </span>
          </div>
          <div className="flex items-center justify-between mt-1 text-[9px] sm:text-[9.5px] font-mono font-semibold">
            <span className="text-cyan-200/90 font-medium">1mg IV Every 3-5min</span>
            {epiTimerStarted ? (
              ...
              <span className="text-[8px] bg-amber-950/80 text-amber-300/90 px-1 rounded border border-amber-800/80 shrink-0 font-sans">
                Req. IV Access
              </span>
            ) : null}
          </div>
        ...
        >
          <div className="flex items-center justify-between">
            <span className="text-[11px] font-black text-indigo-300 font-mono">AMIODARONE</span>
            <span className="text-[10px] font-mono font-bold bg-indigo-950 text-indigo-300 px-1 rounded border border-indigo-800">
              #{amioCount}
            </span>
          </div>
        ...
        >
          <div className="flex items-center justify-between">
            <span className="text-[11px] font-black text-indigo-300 font-mono">LIDOCAINE</span>
            <span className="text-[10px] font-mono font-bold bg-indigo-950 text-indigo-300 px-1 rounded border border-indigo-800">
              #{lidoCount}
            </span>
          </div>
