...
export function CprTimerCard({
  ...
  return (
    <div
      className="bg-slate-900 rounded-xl border border-slate-800 p-2.5 sm:p-4 flex flex-col items-center justify-between relative overflow-hidden shadow-xl shrink-0 min-h-0 sm:min-h-[400px] sm:h-[450px] w-full max-w-full"
    >
      ...
      <div className="w-full mb-2 sm:mb-3">
        <div className="flex items-center p-1 bg-slate-950 rounded-xl border border-slate-800 w-full shadow-inner gap-0.5 sm:gap-1">
          <button
            ...
            className={`flex-1 min-w-0 py-1.5 px-1 sm:px-2 rounded-lg text-[9.5px] xs:text-[10px] sm:text-[11px] font-black transition-all cursor-pointer flex items-center justify-center gap-1 ${
          ...
          >
            ...
            <span className="truncate">CPR 2 นาที (ต่อเนื่อง)</span>
          </button>
          ...
          >
            ...
            <span className="truncate">CPR 30:2 (5 รอบ)</span>
          </button>
        </div>
      </div>

      {/* Timer Digits Display with Circular Progress Gauge */}
      <div style={{ marginTop: '-6px' }} className="flex flex-col items-center justify-center my-1 w-full max-w-full overflow-hidden">
        <div className="relative flex items-center justify-center w-44 h-44 xs:w-52 xs:h-52 sm:w-60 sm:h-60 my-1 sm:my-2.5 max-w-full">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-2">
            <div
              id="timer-display"
              className={`text-3xl xs:text-5xl sm:text-6xl font-mono font-black leading-none tracking-tight tabular-nums ${
            ...
            <span
              className={`text-[9px] xs:text-[10px] font-bold tracking-wider uppercase mt-1.5 xs:mt-2 px-2 py-0.5 rounded-full border transition-all ${
                cprActive
                  ? cprTimeRemaining <= 30
